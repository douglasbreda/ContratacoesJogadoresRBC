...
namespace AnaliseJogadoresRBC
{
    public partial class formPesquisa : Form
    {
        ...
        public virtual void Save()
        {
            ...
            classeDados.ExecuteUpdate( ( DataSet ) bsoPesoContrato.DataSource );
            classeDados.ExecuteUpdate( ( DataSet ) bsoPesoPosicao.DataSource );
        ...
        {
            if( modeNavigation == eNumeradoTipoNavegacao.inclusion || modeNavigation == eNumeradoTipoNavegacao.change )
            {
        ...
        {
            if( modeNavigation == eNumeradoTipoNavegacao.navigation && (bsoPesoContrato.Count == 0 || bsoPesoPosicao.Count == 0) )
            {
            ...
            else if( modeNavigation == eNumeradoTipoNavegacao.navigation && ( bsoPesoContrato.Count > 0 || bsoPesoPosicao.Count > 0 ) )
            {
                btn_add.Enabled = true;
                btn_Cancel.Enabled = false;
                btn_save.Enabled = false;
            ...
            else if( modeNavigation == eNumeradoTipoNavegacao.change )
            {
                ...
                if( ( bsoPesoContrato.Count > 0 || bsoPesoPosicao.Count > 0 ) )//&& Convert.ToInt32( drwBso["id"] ) > 0 )
                {
                    btn_add.Enabled = false;
                    btn_save.Enabled = true;
                    btn_Cancel.Enabled = true;
